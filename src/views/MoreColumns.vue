    ...
    <div id="more-columns">
        ...
        <div class="container">
         ...
         <div class="body">
             ...
             <div class="content">
             <div class="card" v-for="(moreColumn,index) in moreColumns.slice(0,a)" :key="index">
             ...
             <div class="content-bottom">
                 <button class="content-button-btn" v-if="a<moreColumns.length"  @click='showMore'><i class="fa fa-refresh"></i>换一换</button>
                 <button class="content-button-btn" v-else="没有"  @click='showMore'><i class="fa fa-refresh"></i>换一换</button>
